...
import frc.robot.commands.SamarthCommand;
import frc.robot.subsystems.ExampleSubsystem;
import frc.robot.subsystems.SamarthSubsystem;
...
public class RobotContainer {
  ...
  private final SamarthSubsystem m_samarthSubsystem = new SamarthSubsystem();
  private final SamarthCommand m_samarthCommand = new SamarthCommand(m_samarthSubsystem);
  ...
  public RobotContainer() {
    ...
    CommandScheduler.getInstance().setDefaultCommand(m_samarthSubsystem, m_samarthCommand);
  }
